...
import "./loader/loading-screen.css"
...
export function TableFinder() {
  ...
  useEffect(() => {
    ...
    return () => {
      video.removeEventListener("ended", playLoop)
  ...
  return (
    <main
      className={`${theSeasons.variable} ${aboveTheBeyond.variable} loading-screen relative min-h-screen overflow-x-hidden`}
    >
      <video
        ref={videoRef}
        ...
        <div className="mx-auto max-w-xl text-center @container/table-hero">
          <div className="flex items-center justify-center gap-2 sm:gap-3.5">
            <span
              ...
              style={{
                background:
                  "linear-gradient(to right, transparent, color-mix(in srgb, var(--ls-gold) 55%, transparent))",
              }}
              aria-hidden
            />
            <p
            ...
            <span
              ...
              style={{
                background:
                  "linear-gradient(to left, transparent, color-mix(in srgb, var(--ls-gold) 55%, transparent))",
              }}
              aria-hidden
            />
          </div>
          ...
          >
            ...
            <span
              ...
              style={{ fontSize: "var(--script-size)", color: lsGold.soft }}
            >
              Please be seated
            </span>
